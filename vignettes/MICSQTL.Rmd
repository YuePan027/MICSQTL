...
-   protein_data (assay): A subset of proteomic data PsychENCODE (on log scale) 
...
se <- deconv(se, source = "cross", method = "Joint", 
             ...
             ref_pnl = log(se@metadata$ref_gene+1))
```
